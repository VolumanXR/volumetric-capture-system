...
UTILS_DIR = os.path.join(SCRIPT_DIR.parent, 'utils')

# The camera list file is located two directories up, under "utils"
CAMERA_LIST_FILE = os.path.join(UTILS_DIR, 'camera_list.json')
...
def show_starting_alert():
    ...
    logo_path = os.path.join(UTILS_DIR, "Voluman_Logo.png")
